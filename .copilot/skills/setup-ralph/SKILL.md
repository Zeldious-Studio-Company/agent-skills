...
**What this does:**
1. Creates `.copilot/ralph/` structure in your project
...
**After setup, you run:**
```bash
bun run .copilot/ralph/ralph.sh -f <feature-name>
```
</quick_start>
...
| `{ralph_dir}` | string | Path to .copilot/ralph in project |
...
<success_criteria>
✅ Ralph structure created at {project_path}/.copilot/ralph
