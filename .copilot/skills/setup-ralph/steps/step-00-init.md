...
# Note: Use the skill_dir variable which resolves to ~/.copilot/skills/setup-ralph
chmod +x {skill_dir}/scripts/setup.sh
{skill_dir}/scripts/setup.sh "{project_path}" "{feature_name}"
```

The setup script creates:
- `.copilot/ralph/ralph.sh` (main loop)
- `.copilot/ralph/prompt.md` (agent instructions)
- `.copilot/ralph/tasks/{feature_name}/PRD.md` (empty template)
- `.copilot/ralph/tasks/{feature_name}/prd.json` (empty stories)
- `.copilot/ralph/tasks/{feature_name}/progress.txt` (learning log)
